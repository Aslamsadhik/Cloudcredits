    ...
    <title>Online Petmarket Website</title>
...
<div class="modal fade" id="orderModal<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="row">
    ...
    <div class="col-lg-10">
      <input type="number" name="contact" class="form-control" required placeholder="Your number">
    </div>
  </div>
    <div class="row">
    <div class="col-lg-2">
...
if(isset($_POST['savechanges'])){
		...
		$sql =("SELECT * FROM tblorders WHERE cname = '$name'") or die (mysqli_error($con));
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
				...
				$sql = ("INSERT INTO tblorders VALUES(NULL,'$name','$address','$contact','$id','$qty','new',NULL,'$otype','$datep')") or die (mysqli_error($con));
        $result=mysqli_query($con, $sql);
							if($result==true){
