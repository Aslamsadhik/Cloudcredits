        ...
        <section id="contact-info">
            ...
            <div class="left wow fadeInDown">
               ...
               <div class="col-md-6">
                <p class="lead">
                    <br>
                    <p><span style="font-size:20px; font-weight:bold; font-family:verdana; color:red;">Aslam Sadhik</span>
                    <br><b>Address:</b> No:15A,KUMARAN NAGAR,LAWSPET,PONDICHERRY-08.<b><br>Tel/Phone:</b> 8124455352 / 6382779765<b><br>Email Address:</b> aslam303200@gmail.com</p>
                    <hr>
                    <span style="font-size:20px; font-weight:bold; font-family:verdana; color:Violet;">We are open</span>
                    <p><b>MONDAY TO FRIDAY -- 9:00AM - 8:00PM</b></p>
                </p>
                <hr>
