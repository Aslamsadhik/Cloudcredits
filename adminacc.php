...
<head>
    ...
    <link href="images\Picsart_23-10-01_15-32-17-441.png" rel="shortcut icon">
    <title>ADMIN |Online petmarket </title>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="images\Picsart_23-10-01_15-32-17-441.png" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>
            <?php
                session_start();
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2023 online Petmarket. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
